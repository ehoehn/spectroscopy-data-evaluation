    ...
    if dateiname.endswith('.csv'):
      ...
      #      print(x) # Wellenlängenverschiebung
        ...
        #    print(y) # Intensitäten
            plotly_xy_yFehler(x_values=x, y_values=y, y_range=None, dateiname=dateiname, suffix_for_new_filename=suffix_for_new_filename, xaxis_title='Raman shift / cm<sup>-1</sup>', yaxis_title='intensity / a. u.', x_lables=True, y_lables=True)
