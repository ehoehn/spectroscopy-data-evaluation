...
def plotly_xy_yFehler(x_values, y_values, errorx=None, errory=None, dateiname=None, suffix_for_new_filename=None, x_range=None, y_range=None, x_dtick=None, y_dtick=None, xaxis_title='', yaxis_title='', x_lables=True, y_lables=True, z_lables=True):
    ...
    plotly.offline.plot(fig, filename=nwfile, auto_open=True, image_filename=nwfile, image='svg', image_width=600, image_height=560)
    ...
    if dateiname.endswith('.csv'):
      ...
      #      print(x) # Wellenlängenverschiebung
        ...
        #    print(y) # Intensitäten
            ...
            plotly_xy_yFehler(x_values=x, y_values=y, x_range=[150,2000], dateiname=dateiname, suffix_for_new_filename=suffix_for_new_filename, xaxis_title=xaxislable, yaxis_title=yaxislable, x_lables=True, y_lables=True)
