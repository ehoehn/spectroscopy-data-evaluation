    ...
    if dateiname.endswith('.csv'):
        ...
        with open(dateiname) as fd:
         ...
         #   print(x)
          ...
          #  print(y)
            plotly_xy_yFehler(x_values=x, y_values=y, x_range=None, y_range=None, x_dtick=100, dateiname=dateiname, suffix_for_new_filename=suffix_for_new_filename, xaxis_title='time [s]', yaxis_title='intensity [a. u.]', x_lables=True, y_lables=True, z_lables=True)
