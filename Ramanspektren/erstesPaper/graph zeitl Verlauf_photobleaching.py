...
for dateiname in os.listdir():
    if dateiname.endswith('normalized.csv'):
        ...
        #  print(y)
            ...
            plotly_xy_yFehler(x_values=x, y_values=y, x_range=[0, x.iloc[-1]], y_range=[0, 150], dateiname=dateiname, suffix_for_new_filename=suffix_for_new_filename, xaxis_title=xaxislable, yaxis_title=yaxislable, x_lables=True, y_lables=True, z_lables=True)
